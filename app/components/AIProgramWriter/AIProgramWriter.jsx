...
export default function AIProgramWriter({ programId, wizardComplete }) {
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-0 min-h-[400px] lg:min-h-[600px] w-full">
      ...
      <div className={`
        ...
        overflow-y-auto lg:max-h-[calc(100vh-220px)]
      ...
      <div className="flex-1 min-w-0 p-4 lg:p-6 overflow-y-auto lg:max-h-[calc(100vh-220px)]">
        {/* Workouts Header */}
