...
import { Brain, Dumbbell, Heart, Target, TrendingUp, Zap } from 'lucide-react';
...
const goals = [
  ...
  },
  {
    ...
    emoji: '🏃',
    description: 'Enhance cardiovascular endurance and work capacity',
    icon: Heart,
  },
  {
    id: 'general_fitness',
    ...
    emoji: '⚡',
    description: 'Well-rounded approach to overall fitness',
    icon: Zap,
  },
  {
    ...
    emoji: '🏆',
    description: 'Train for athletic competition and sport-specific goals',
    icon: TrendingUp,
  },
  {
    id: 'body_composition',
    ...
    emoji: '🎯',
    description: 'Build muscle and reduce body fat',
    icon: Target,
  },
  {
...
const methodologies = [
  ...
  },
  {
    ...
    description: 'Snatch and clean & jerk focused training',
  },
  {
    id: 'bodybuilding',
    label: 'Bodybuilding',
  ...
  },
  {
    ...
    description: 'Movements that translate to everyday life',
  },
...
export default function ProgramSetupStep({ formData, onFieldChange, onNext }) {
